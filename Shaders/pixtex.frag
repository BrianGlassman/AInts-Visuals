...
float fade(float offset)
{
   ...
   float a = 2*amp * abs(gl_TexCoord[0].y / p - floor(gl_TexCoord[0].y / p + 0.5)) - offset;
...
void main()
{
   ...
   vec4 t0 = texture2D(tex0, gl_TexCoord[0].xz);
   vec4 t1 = texture2D(tex1, gl_TexCoord[0].xz);
   vec4 t2 = texture2D(tex2, gl_TexCoord[0].xz);
   vec4 t3 = texture2D(tex3, gl_TexCoord[0].xz);
   vec4 t4 = texture2D(tex4, gl_TexCoord[0].xz);
   vec4 t5 = texture2D(tex5, gl_TexCoord[0].xz);
   vec4 t6 = texture2D(tex6, gl_TexCoord[0].xz);
   vec4 t7 = texture2D(tex7, gl_TexCoord[0].xz);
   vec4 t8 = texture2D(tex8, gl_TexCoord[0].xz);
   vec4 t9 = texture2D(tex9, gl_TexCoord[0].xz);
   vec4 t10 = texture2D(tex10, gl_TexCoord[0].xz);
   vec4 t11 = texture2D(tex11, gl_TexCoord[0].xz);
   vec4 t12 = texture2D(tex12, gl_TexCoord[0].xz);
   vec4 t13 = texture2D(tex13, gl_TexCoord[0].xz);
   vec4 t14 = texture2D(tex14, gl_TexCoord[0].xz);
   vec4 t15 = texture2D(tex15, gl_TexCoord[0].xz);
   vec4 t16 = texture2D(tex16, gl_TexCoord[0].xz);
